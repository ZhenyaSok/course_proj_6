...
from client_service.models import Logs
...
def get_count_mailing():
    ...
    return SettingMailing.objects.count()


def get_active_mailing():
    """Возвращает количество активных рассылок"""
    return SettingMailing.objects.filter(status='START').count()
