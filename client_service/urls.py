...
from client_service.views import MessageListView, MessageCreateView, MessageUpdateView, MessageDetailView, MessageDeleteView
    # SettingMailingDetailView, SettingMailingListView, SettingMailingUpdateView, \
    # SettingMailingDeleteView, LogsListView, LogsDetailView, LogsDeleteView, SettingMailingCreateView
